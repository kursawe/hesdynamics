...
import subprocess
import time
import make_dataset_job_list_experimental_multiple
...
def make_and_submit_jobscripts(joblist_path):
    ...
    for job_file in os.listdir(joblist_path):
        ...
        for line in job_file:
            ...
            job_script.write('\ncd ~/scratch/hesdynamics/test/test_burton_et_al_2022/')
            job_script.write('\n' + line)
            job_script.write('\n\n')
...
if __name__ == "__main__":
    # make joblists
    saving_path = make_dataset_job_list_experimental_multiple.main()

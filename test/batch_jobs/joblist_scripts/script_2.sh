...
python -c "import test_inference; class_instance = test_inference.TestInference(); class_instance.test_multiple_mala_traces_in_parallel('protein_observations_360_ps3_ds4.npy')"

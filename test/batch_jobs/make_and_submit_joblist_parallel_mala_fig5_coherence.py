...
import subprocess
import time
import make_dataset_job_list_fig5_coherence
...
def make_and_submit_jobscripts(joblist_path):
    ...
    for job_file in os.listdir(joblist_path):
        ...
        for line in job_file:
            jobscript_file_name = os.path.join(jobscripts_directory, 'script_'+ line[line.find('protein')+21:line.find('.npy')] + '.sh')
...
if __name__ == "__main__":
    # make joblists
    saving_path = make_dataset_job_list_fig5_coherence.main()

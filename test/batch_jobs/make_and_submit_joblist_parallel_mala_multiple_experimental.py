...
import subprocess
import time
import make_dataset_job_list_multiple_experimental
...
def make_and_submit_jobscripts(joblist_path):
    ...
    for job_file in os.listdir(joblist_path):
        ...
        for line in job_file:
            jobscript_file_name = os.path.join(jobscripts_directory, 'script_'+ line[line.find("=\'")+2:line.find("\',")] + '_cluster_' + line[line.find("r=\'")+3] + '.sh')
            ...
            job_script.write('\ncd ~/scratch-new/hesdynamics/test/')
            job_script.write('\n' + line)
            job_script.write('\n\n')
...
if __name__ == "__main__":
    # make joblists
    saving_path = make_dataset_job_list_multiple_experimental.main()
